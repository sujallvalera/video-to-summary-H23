...
def script():
    ...
    completion = openai.ChatCompletion.create(
        ...
        messages=[
            {"role": "user",
             "content": f"I want you to summarize the following to a small short actually very short and sweet summary which should cover all the points of the given text. Here's the text - {text}"}
        ]
    )
